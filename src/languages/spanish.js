...
export default {
  ...
  botmenu: {
    key: keyGen(),
    defaultMessage: 'Larva del moscardón'
  },
  botControlbot: {
    key: keyGen(),
    defaultMessage: 'Bot de control'
  },
  botTickers: {
    key: keyGen(),
  ...
  botOpportunity: {
    key: keyGen(),
    defaultMessage: 'Oportunidad'
  },
  botOppcertification: {
    key: keyGen(),
    defaultMessage: 'Certificación Opp'
  },
  botResults: {
    key: keyGen(),
  ...
  botResultscertification: {
    key: keyGen(),
    defaultMessage: 'Certificación de resultados'
  },
  botMlresult: {
    key: keyGen(),
    defaultMessage: 'Resultado ML'
  },
  botMainnetresultscertification: {
    key: keyGen(),
    defaultMessage: 'Certificación de resultados de Mainnet'
  },
  botMainnetopportunitiescertification: {
    key: keyGen(),
    defaultMessage: 'Certificación de oportunidades de Mainnet'
  },
