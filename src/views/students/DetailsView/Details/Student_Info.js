        ...
        <Grid item xs={12} sm={6}>
          <Grid container>
            ...
            <Grid item xs={8} className={classes.rightdetail_container}>
              <div style={{ marginBottom: 7 }}>{student[0].level ? student[0].level : 'NULL'}</div>
              <div style={{ marginBottom: 7 }}>{student[0].tel ? student[0].tel : 'NULL'}</div>
              <div style={{ marginBottom: 7 }}>{student[0].email ? student[0].email : 'NULL'}</div>
              <div style={{ marginBottom: 7 }}>{student[0].enrolled ? student[0].enrolled : 'NULL'}</div>
            </Grid>
          </Grid>
        </Grid>
        <Grid item xs={12} sm={6}>
          ...
          <Grid container>
            ...
            <Grid item xs={9} className={classes.leftdetail_container} style={{ paddingTop: 0, paddingBottom: 0 }}>
              <div style={{ marginBottom: 7 }}>Payment</div>
