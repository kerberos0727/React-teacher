...
const LanguageListView = ({ intl }) => {
  ...
  const getLanguages = useCallback(async () => {
    try {
      const response = await axios.get(`api/more/languages/all`);
...
export default connectIntl(mapStateToProps)(LanguageListView);
